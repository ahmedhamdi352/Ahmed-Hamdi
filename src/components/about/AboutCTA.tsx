...
export function AboutCTA() {
  return (
    <section className="bg-[var(--charcoal)] py-20 text-[#f7f3ea] sm:py-24">
      <Container>
        <Reveal className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
        <div><p className="section-label">Next step</p><h2 className="font-display mt-4 text-5xl tracking-[-0.04em] sm:text-6xl">Interested in working together?</h2></div>
          <div className="flex flex-wrap gap-3">
            ...
            <a href={siteConfig.cvPath} download aria-label="Download Ahmed Hamdi CV" className="inline-flex h-12 items-center gap-2 px-3 text-sm text-[#b8b0a6] hover:text-[#f7f3ea]"><Download aria-hidden="true" className="size-4" />CV</a>
          </div>
        </Reveal>
      </Container>
    </section>
